...
//				nodoUltimo = null;
	...
	public Integer obtenerMayor() {
		...
		Integer mayor =  (Integer) obtenerValorNodo(0);
		Integer num = obtenerNumMayor(0,mayor);
	...
	private Integer obtenerNumMayor( int i, Integer mayor) {

		if(tamanio-1 == i){

			return (Integer) obtenerValorNodo(i);

		}else{

			Integer num1 = obtenerNumMayor(++i, mayor);
			Integer num2 = (Integer)  obtenerValorNodo(i);
			if(num1 > num2){
				mayor = num1;
			}else{
				mayor = num2;
	...
	public  Nodo<T> concatenar(ListaSimple<T> listaConcatenar) {
		...
		aux.setSiguienteNodo(listaConcatenar.nodoPrimero);
